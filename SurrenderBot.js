...
class SurrenderBot {
  constructor(username, password, url, extensionPath) {
  ...
  async run() {
    ...
    while (true) {
      try {
        ...
        const battleCancelledButton = await page.$(
          "div::-p-text(BATTLE CANCELLED)"
        );
        ...
        // Click ok button after surrender
